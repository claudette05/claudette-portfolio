...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/claudette05" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/claudette-cobbah-4969942b5?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" },
  { icon: Instagram, link: "https://www.instagram.com/_claudette.ee/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                Crafting digital experiences that are innovative, functional, and empowering for real-world users.
